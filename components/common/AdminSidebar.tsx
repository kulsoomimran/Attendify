...
import { Clock, Users, Calendar, ShieldAlert, BarChart3, Settings, Menu, X } from "lucide-react";
...
export default function AdminSidebar() {
  ...
  const navItems = [
    ...
    { name: "Leaves", href: "/admin/leaves", icon: ShieldAlert },
      ...
      >
        ...
        <div className="flex flex-col space-y-8 px-4 py-6 flex-1">
          ...
          <div className="flex items-center justify-between px-2">
            ...
            >
              <Image src="/Attendify.jpg" alt="Attendify logo" width={32} height={32} className="rounded-xl" />
              {!isCollapsed && (
            ...
            <div className="md:hidden flex items-center justify-between w-full">
              <Link href="/" className="flex items-center gap-2" id="sidebar-logo">
                <Image src="/Attendify.jpg" alt="Attendify logo" width={32} height={32} className="rounded-xl" />
          ...
          {/* Navigation Links */}
          <nav className="flex flex-col space-y-1" id="sidebar-nav">
            {navItems.map((item) => {
